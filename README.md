...
3. Run the code and see the **console output** directly.
   ...
   ## Methodology
 **Data Simulation:** Created training and inference datasets with multiple features.  
 **Model Training:** Built a baseline model to simulate predictions.  
 **Drift Detection:** Implemented **data drift detection** by comparing feature distributions between training and new data.  
 **Performance Monitoring:** Monitored model accuracy and triggered **alerts** when performance dropped.  
 **Automation:** Designed the system to be **fully self-contained**, easily runnable from GitHub.  
